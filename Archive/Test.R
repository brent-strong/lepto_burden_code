...
sim_results <- readRDS("filename.rds")
...
dMarginalized(sim_results$data_list$Y[,,80],n_rt=2,n_t=36,n_r=2,nu=c(0.6,0.9),
                kappa=c(0.9,0.9),piDR=0.33,piDT=0.75,lambda_D=4,
